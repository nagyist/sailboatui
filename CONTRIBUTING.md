...
> [Documentation](https://github.com/sailboatui/sailboatui).

Before you ask a question, it is best to search for existing [Issues](https://github.com/sailboatui/sailboatui/issues)
that might help you. In case you have found a suitable issue and still need clarification, you can write your question
in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/sailboatui/sailboatui/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  components/versions (Make sure that you have read the [documentation](https://github.com/sailboatui/sailboatui). If you are
...
- Open an [Issue](https://github.com/sailboatui/sailboatui/issues/new). (Since we can't be sure at this point whether
...
This section guides you through submitting an enhancement suggestion for Sailboat UI, **including completely new
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/sailboatui/sailboatui) carefully and find out if the functionality is already
  covered, maybe by an individual configuration.
- Perform a [search](https://github.com/sailboatui/sailboatui/issues) to see if the enhancement has already been
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/sailboatui/sailboatui/issues).
...
- **Explain why this enhancement would be useful** to most Sailboat UI users. You may also want to point out the other
